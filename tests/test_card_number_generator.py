...
def test_wrong_symbols_card_number_generator():
    ...
    assert next(generator) == "You've entered  wrong start or stop value. Please enter digits only in range 0 - 9999 9999 9999 9999"
...
def test_out_of_range_card_number_generator():
    ...
    assert next(generator) == "You have gone beyond the acceptable range of values. Please enter start/stop values in range 0 - 9999 9999 9999 9999"
