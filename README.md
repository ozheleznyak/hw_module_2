...
- Модуль **decorators**, в котором реализован декоратор log:
  - По умолчанию, декоратор выводит в консоли лог выполнения функции:
  
    - Таймстэмп начала и окончания выполнения функции в формате ОС.
    - Результат выполнения: OK, если ошибок не было; текст ошибки и переданные параметры,
    если были ошибки выполнения функции
  - Если в декоратор передается название лог-файла, то декоратор записывает лог в указанный файл в папке /logs.
