...
- Модуль **transactions_from_csv.py**, в котором реализована функциия считывания данных из csv файла
и преобразования их в словарь, а также запись в data/output_csv.json
- Модуль **transactions_from_excel.py**, в котором реализована функциия считывания данных из xlsx файла
и преобразования их в словарь, а также запись в data/output_excel.json
...
- Модуль **transactions_from_csv**, тест test_transactions_from_csv.
Описание каждого теста см. в документации к юнит-тестам
- Модуль **transactions_from_excel**, тест test_transactions_from_excel.
Описание см. в документации к юнит-тестам
